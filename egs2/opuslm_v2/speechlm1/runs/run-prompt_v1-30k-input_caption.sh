...
test_sets=""
test_sets+="dialogue:audio_edit-prompts_v1-add_v1-input_caption-test "
test_sets+="dialogue:audio_edit-prompts_v1-remove_v1-input_caption-test "
test_sets+="dialogue:audio_edit-prompts_v1-effect_v1-input_caption-test "
...
bash launch_opuslm_stage3_sft.sh \
    ...
    --exp_dir exp/edit-prompt_v1-all_v1-30k-input_caption \
    --stop_stage 3 \
    "$@"
