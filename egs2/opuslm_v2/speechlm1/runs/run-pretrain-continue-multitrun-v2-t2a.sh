...
train_sets+="dialogue:sft-part2_4-vad-music.min_10-dialogue.step2.t2a_t2a " # 100,000
train_sets+="dialogue:sft-part2_4-vad-sound.min_10-dialogue.step2.t2a_t2a " # 95,467
train_sets+="dialogue:sft-part2_4-vad-sound.min_7.max_10-dialogue.step2.t2a_t2a " # 59,236
train_sets+="dialogue:sft-part2_4-vad-speech.min_5.max_8-dialogue.step2.t2a_t2a " # 100,000
train_sets+="dialogue:sft-part2_4-vad-speech.min_20.max_25-dialogue.step2.t2a_t2a " # 68,666
train_sets+="dialogue:sft-part2_4-vad-speech.min_25-dialogue.step2.t2a_t2a " # 100,000
...
train_sets+="dialogue:sft-part2_4-novad-music.min_10-dialogue.step4.t2a_t2a.default:0.01 " # 157,906
train_sets+="dialogue:sft-part2_4-novad-sound.min_10-dialogue.step4.t2a_t2a.default:0.01 " # 95,467
train_sets+="dialogue:sft-part2_4-novad-speech.min_5.max_8-dialogue.step4.t2a_t2a.default:0.005 " # 181,581
train_sets+="dialogue:sft-part2_4-novad-speech.min_8.max_20-dialogue.step4.t2a_t2a.default:0.005 " # 156,354
...
train_sets+="dialogue:train_clean_audioset-v2-music_add_mix-t2a_t2a " # 3,000
train_sets+="dialogue:train_clean_audioset-v2-music_remove_mix-t2a_t2a " # 2,998
train_sets+="dialogue:train_clean_audioset-v2-music_replace_mix-t2a_t2a " # 2,979
train_sets+="dialogue:train_clean_audioset-v2-sing_add_mix-t2a_t2a " # 1,000
train_sets+="dialogue:train_clean_audioset-v2-sing_remove_mix-t2a_t2a " # 999
train_sets+="dialogue:train_clean_audioset-v2-sing_replace_mix-t2a_t2a " # 996
train_sets+="dialogue:train_clean_audioset-v2-sound_add_mix-t2a_t2a " # 3,000
train_sets+="dialogue:train_clean_audioset-v2-sound_remove_mix-t2a_t2a " # 3,000
train_sets+="dialogue:train_clean_audioset-v2-sound_replace_mix-t2a_t2a " # 2,987
train_sets+="dialogue:train_clean_audioset-v2-speech_add_mix-t2a_t2a " # 10,000
train_sets+="dialogue:train_clean_audioset-v2-speech_remove_mix-t2a_t2a " # 9,996
train_sets+="dialogue:train_clean_audioset-v2-speech_replace_mix-t2a_t2a " # 9,979
# speech-edit data: ~ 40k
train_sets+="dialogue:part2-speech_edit-v2-transcription_del-t2a_t2a " # 6,721
train_sets+="dialogue:part2-speech_edit-v2-transcription_ins-t2a_t2a " # 9,949
train_sets+="dialogue:part2-speech_edit-v2-transcription_replace_sentence-t2a_t2a " # 8,558
train_sets+="dialogue:part2-speech_edit-v2-transcription_sub-t2a_t2a " # 7,740
...
valid_sets+="dialogue:part2_4_debug-vad-sound.min_7.max_10-dialogue.step2.t2a_t2a "
