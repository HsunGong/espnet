...
bash launch_opuslm_stage3_sft.sh \
    ...
    --train_config conf/train_stage3_qwen3_enh-v3-resume-accum4.yaml \
    --resume_path /mnt/home/jinchuat-andr-d6b58f/jinchuat/espnet_sft/egs2/opuslm_v2/speechlm1/exp/opuslm_v2_stage3_sft_gen_v1/checkpoints/step_374300 \
    --exp_dir exp/opuslm_v2_stage3_sft_librimix_enh-v3_resume-t2a-accum4 \
    "$@"
