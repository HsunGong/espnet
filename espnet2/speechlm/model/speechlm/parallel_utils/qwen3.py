...
"""Parallelization utilities for HuggingFace Qwen3 models (FSDP2 only).

This module provides activation checkpointing, torch.compile, and FSDP2
wrapping for HuggingFace Qwen3 models used in the SpeechLM framework.
It follows TorchTitan's parallelization patterns adapted for the HuggingFace
model structure.
...
def parallelize_qwen3_hf(
    ...
    Order: activation checkpointing -> torch.compile -> FSDP
